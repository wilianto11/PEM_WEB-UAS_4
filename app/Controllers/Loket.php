...
class Loket extends Controller
{
 ...
 public function delete($id)
    ...
    $name = $this->request->getPost('nama_loket');
    $code = $this->request->getPost('id_loket_pelayanan');
    $desc = $this->request->getPost('keterangan_loket');
 
    // Membuat array collection yang disiapkan untuk insert ke table
    $data = [
        'nama_loket' => $name,
        'keterangan_loket' => $desc,
        'id_loket_pelayanan' => $code
    ];
