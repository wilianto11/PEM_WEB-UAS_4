...
class Pelayanan extends Controller
{
 ...
 public function delete($id)
    ...
    $name = $this->request->getPost('nama_pelayanan');
    $code = $this->request->getPost('kode_pelayanan');
    $desc = $this->request->getPost('keterangan_pelayanan');
 
    // Membuat array collection yang disiapkan untuk insert ke table
    $data = [
        'nama_pelayanan' => $name,
        'kode_pelayanan' => $code,
        'keterangan_pelayanan' => $desc
    ];
