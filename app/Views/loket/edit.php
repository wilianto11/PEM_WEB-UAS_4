...
<body id="page-top">
    ...
    <div class="container">
        ...
        <hr>
        <form action="<?php echo base_url('loket/update/'.$loket['id_loket']); ?>" method="post">
 
            <div class="form-group">
                <label for="">Nama Loket</label>
                <input type="text" name="nama_loket" value="<?php echo $loket['nama_loket']; ?>" class="form-control" placeholder="Nama Loket">
            </div>
               <div class="form-group">
...
<?php 
            ...
            <div class="form-group">
                ...
                <input type="text" name="keterangan_loket" value="<?php echo $loket['keterangan_loket']; ?>" class="form-control" placeholder="Keterangan">
            </div>
            <div class="form-group">
