    ...
    <div class="container">
        ...
        <form action="<?php echo base_url('pelayanan/store'); ?>" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" name="kode_pelayanan" class="form-control" placeholder="Kode Pelayanan">
            </div>
            <div class="form-group">
                <label for="">Keterangan Pelayanan</label>
                <textarea name="keterangan_pelayanan"class="form-control" placeholder="Keterangan pelayanan"></textarea>
            </div>
            <div class="form-group">
