...
<body id="page-top">
    ...
    <div class="container">
        ...
        <hr>
        <form action="<?php echo base_url('pelayanan/update/'.$pelayanan['id_pelayanan']); ?>" method="post">
 
            <div class="form-group">
                <label for="">Nama Pelayanan</label>
                <input type="text" name="nama_pelayanan" value="<?php echo $pelayanan['nama_pelayanan']; ?>" class="form-control" placeholder="Nama Pelayanan">
            </div>
            <div class="form-group">
                <label for="">Kode Pelayanan</label>
                <input type="text" name="kode_pelayanan" value="<?php echo $pelayanan['nama_pelayanan']; ?>" class="form-control" placeholder="Kode pelayanan">
            </div>
            <div class="form-group">
                <label for="">Keterangan Pelayanan</label>
                <textarea name="keterangan_pelayanan" class="form-control" placeholder="Keterangan Pelayanan"><?php echo $pelayanan['keterangan_pelayanan']; ?></textarea>
            </div>
            <div class="form-group">
