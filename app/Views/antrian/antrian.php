...
<body class="is-boxed has-animations">
    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        ...
        <?php 
                    foreach($antrian as $key => $data) {  $a = $data['id_antrian']; 
    ...
    <div class="container position-relative" data-aos="fade-up" data-aos-delay="100">
      <div class="row justify-content-center">
        <div class="col-xl-7 col-lg-9 text-center">
          <h1>NOMOR ANTRIAN</h1>
                            <h2 class="hero-paragraph is-revealing">
                                <?php 
                                  $request = \Config\Services::request();
                                  $s = $request->uri->getSegment(3);
                                 if ($s == '4') {
                                                       echo "Nomor antrian Anda Pelayanan CUSTOMER SERVICE dengan Nomor Atrian <br><h1> CS".$a;               
                                                                   }  elseif ($s == '5') {
                                                                       echo "Nomor antrian Anda Pelayanan PENGADUAN dengan Nomor Atrian <br><h1> PG".$a;   
                                                                   }  elseif ($s == '6') {
                                                                       echo "Nomor antrian Anda Pelayanan PERMOHONAN BARU dengan Nomor Atrian <br><h1> PB".$a;   
                                                                   } elseif ($s == '7') {
                                                                       echo "Nomor antrian Anda Pelayanan PERPANJANGAN dengan Nomor Atrian <br><h1> PJ".$a;   
                                                                   }                   
                                ?>
                             </h2>
                        </div>
